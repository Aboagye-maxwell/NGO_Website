...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col p-0">
            <img class="" width="100%" height="100%" src="/storage/mountani top.jpg" alt="">
        </div>
    </div>
            ...
            <div class="col-sm">
                <div class="card card-right" id="card-right">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row" style="padding:0px 0px 0px 15px">
                            <div class="col p-0">
                                <p class="">Water proof beautiful bags designed to carry few single reusable pads for storage and transport. </p>
                            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-5">
                    <div class="card rcard">
                        <div class="believe-head" style="background-color: #213e8c;">
                        <p>We believe in menstruation as an avenue for empowerment. Therefore we:</p></div>                    
                    </div>

                    <div class="card rcard" style="color: white; text-align:left; padding:10px 10px 10px 20px; background-color:#c84869; width:90%; margin:10px 0px 10px 50px">
                                Create affordable and environmentally friendly sanitary materials for girls and women to manage their
                                 menstruation
                        </div>

                        <div class="card rcard" style="color: white; text-align:left; padding:10px 10px 10px 20px; background-color:#2a70de; width:90%; margin:10px 50px 10px 0px">
                        Break the stigma and barriers associated with menstruation for women and girls
                        </div>

                        <div class="card rcard" style="color: white; text-align:left; padding:10px 10px 10px 20px; background-color:#2a70de; width:90%; margin:10px 50px 10px 0px">
                        Advocate for a supportive environment for menstruating females
                        </div>
                </div>
            </div>
         <div class="col" style="text-align: right;">
            <p>We believe in menstruation as an avenue for empowerment. Therefore we:<br></p><hr>
            <h5> &#9792 Create affordable and environmentally friendly sanitary materials for girls and women to manage their
                menstruation.</h5>
                <hr>                
            <h5>  &#9792 Break the stigma and barriers associated with menstruation for women and girls.</h5><hr>
            <h5> &#9792 Advocate for a supportive environment for menstruating females</h5>
        </div>
    </div>
</div>
...
<style>
    .believe{
        background-image: url('storage/mountani top.jpg');
...
function scrollFunction() {
    if (pageYOffset > 600 && pageYOffset < 1000) {
    ...
    if (pageYOffset > 650 && pageYOffset < 1000) {
